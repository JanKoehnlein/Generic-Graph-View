 ...
 * <ul>
 *   <li>{@link org.eclipse.xtext.graphview.map.graphViewMapping.impl.AbstractExpressionMappingImpl#getName <em>Name</em>}</li>
 ...
 * @generated
 */
public class AbstractExpressionMappingImpl extends JvmIdentifiableElementImpl implements AbstractExpressionMapping
{
  /**
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GraphViewMappingPackage.ABSTRACT_EXPRESSION_MAPPING__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case GraphViewMappingPackage.ABSTRACT_EXPRESSION_MAPPING__NAME:
        return getName();
