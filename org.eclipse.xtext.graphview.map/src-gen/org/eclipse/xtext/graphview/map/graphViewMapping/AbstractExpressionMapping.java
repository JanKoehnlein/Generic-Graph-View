 ...
 * <ul>
 *   <li>{@link org.eclipse.xtext.graphview.map.graphViewMapping.AbstractExpressionMapping#getName <em>Name</em>}</li>
 ...
 * @generated
 */
public interface AbstractExpressionMapping extends JvmIdentifiableElement
{
  /**
   ...
   * @see #setName(String)
   * @see org.eclipse.xtext.graphview.map.graphViewMapping.GraphViewMappingPackage#getAbstractExpressionMapping_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link org.eclipse.xtext.graphview.map.graphViewMapping.AbstractExpressionMapping#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
