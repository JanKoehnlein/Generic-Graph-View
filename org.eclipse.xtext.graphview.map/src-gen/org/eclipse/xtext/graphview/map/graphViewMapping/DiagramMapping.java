 ...
 *   <li>{@link org.eclipse.xtext.graphview.map.graphViewMapping.DiagramMapping#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.xtext.graphview.map.graphViewMapping.DiagramMapping#getTypeGuard <em>Type Guard</em>}</li>
 *   <li>{@link org.eclipse.xtext.graphview.map.graphViewMapping.DiagramMapping#getMappings <em>Mappings</em>}</li>
 * </ul>
 * </p>
 *
 ...
 * @generated
 */
public interface DiagramMapping extends JvmIdentifiableElement
{
  /**
   ...
   * @see #setName(String)
   * @see org.eclipse.xtext.graphview.map.graphViewMapping.GraphViewMappingPackage#getDiagramMapping_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link org.eclipse.xtext.graphview.map.graphViewMapping.DiagramMapping#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.eclipse.xtext.graphview.map.graphViewMapping.GraphViewMappingPackage#getDiagramMapping_Mappings()
   * @model containment="true"
   * @generated
   */
